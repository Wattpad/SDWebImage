...
typedef void(^SDWebImageQueryCompletedBlock)(SDImage *image, SDImageCacheType cacheType);
...
/**
 * If set to YES, last access date will be used instead of last modified date when cleaning disk.
 */
